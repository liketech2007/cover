...
export function HeaderBlog() {
    ...
    return (
        <header className={ `insert-0 z-10 bg-white p-4 flex justify-between items-center w-full md:px-20 lg:px-50 rounded-b-lg drop-shadow-md ${openMenu === true ? "absolute inset-0 z-10": ""}`}>
            ...
            <ul className="gap-4 text-sm hidden lg:flex">
               <Link href="/" className="border-b-0 border-t-0 border-r-0 boder-l-0 border-blue-500 p-4 hover:border-b  transition-all flex justify-center items-center">Home</Link>
            ...
            <List className={openMenu === true ? "hidden text-black bg-white" : "block"}  size={48} onClick={() => setOpenMenu(true)}/>
            {
                ...
                <div className="flex flex-col justify-end items-end gap-6">
                    ...
                    <ul className="flex flex-col gap-4 text-sm ">
                        <Link href="/" className="border-b-0 border-t-0 border-r-0 boder-l-0 border-blue-500 p-4 hover:border-b  transition-all flex justify-center items-center" onClick={() => setOpenMenu(false)}>Home</Link>
                        ...
                        Mais
                        <CaretDown className="text-sm" />
                        <div className={` ${openMais === true ? "block p-3" : "hidden"}`}>
                        <ul>
